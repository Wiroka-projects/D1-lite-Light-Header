...
int defaultG1 = 197;    // Default green for strip 1
int defaultB1 = 143;    // Default blue for strip 1
int defaultR2 = 255;    // Default red for strip 2
int defaultG2 = 197;    // Default green for strip 2
int defaultB2 = 143;    // Default blue for strip 2
int brightnessRgb1 = 180; // Brightness for strip 1 (0-255)
int brightnessRgb2 = 180; // Brightness for strip 2 (0-255)
...
void handleConfigCommand(JsonDocument& doc) {
  ...
  if (setting == "lb_threshold") {
    ...
    // ================================
    sendError("Invalid setting. Available: lb_threshold, rgb1_pixels, rgb2_pixels, rgb1_default_color, rgb2_default_color, rgb1_brightness, rgb2_brightness");
  }
}
void sendSuccess(String message) {
  JsonDocument response;
